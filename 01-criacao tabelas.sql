...
CREATE TABLE ESTOQUE_MOV
	...
	REFERENCES MATERIAL(COD_EMPRESA,COD_MAT)
	--CAMPO LOGIN TABELA ESTOQUE_MOV CRIANDO APOS TABELA USUARIO
	);
...
--CRIANDO CONDICAO DE PAGTO COM PARCELA
...
--CRIANDO DE VENDAS RELACIONA GERENTE COM VENDEDOR
...
--CRIANDO VENDAS RELACIONA VENDEDOR COM CLIENTE
...
--CRIANDO DE TABELA PARA REGISTRA META DE VENDAS MES A MES/ANO
...
--CRIANDO DA TABELA DOS CODIGO DE OPERACOES FISCAIS
CREATE TABLE CFOP
	(
...
--CRIANDO DA TABELA NOTA_FISCAL_ITENS
...
--CRIANDO TABELAS PARAMETRO DE INSS
...
--CRIANDO DE TABELAS DE PARAMETRO DO IRRF
...
--ADD CAMPO LOGIN TABELA APONTAMENTOS CRIANDO APOS TABELA USUARIOS E FK
...
--ADD CAMPO LOGIN TABELA ESTOQUE_MOV  CRIANDO APOS TABELA USUARIO
